...
export default function ProductDetail() {
    ...
    productsFiltered.discountPercentage < 15 ? (
      ...
      <div>
        <p className="text-colorLight3 font-semibold line-through text-xl">
          $
          {Math.round(
            (productsFiltered.price * productsFiltered.discountPercentage) /
              100 +
  ...
  return (
    <div className="flex min-h-screen m-auto mt-11 p-2 flex-col gap-2 max-w-4xl text-colorDark1 md:grid md:grid-cols-2">
